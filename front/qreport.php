...
$esql = "SELECT time, agent, queuename, event, data3 FROM queue_log WHERE queuename IN ($queue) AND time >= '$start' AND time <= '$end' AND event IN ('CONNECT', 'ENTERQUEUE', 'COMPLETECALLER', 'COMPLETEAGENT', 'RINGNOANSWER')";
