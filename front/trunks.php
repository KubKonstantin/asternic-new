...
?>
<?php
$sql_ans = "select calldate, dst, channel, uniqueid, disposition, lastapp, lastdata from cdr where lastdata LIKE ($queue) and calldate >= '$start' and calldate <= '$end' and disposition in ('ANSWERED');";
